...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            skills: ["Programming Languages", "Databases", "Data Science Frameworks", "Web Dev Frameworks", "Machine Learning skills", "Deep Learning Skills", "Web Development", "Software Development Skills"],
            projects: ["Time Series Forecasting for CoronaVirus Using Pytorch", "Traffic Sign Detection", "Credit Card Fraud Detection", "Weather App", "Face Detection on Custom Dataset Using Detectron2"],
            interests: ["Social Engineering", "Interesting Technologies", "IOT", "Offensive Security"],
